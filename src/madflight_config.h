...
//--- RC RECEIVER
#define RCIN_USE  RCIN_USE_IBUS // Select one: RCIN_USE_CRSF, RCIN_USE_SBUS, RCIN_USE_DSM, RCIN_USE_PPM, RCIN_USE_PWM
#define RCIN_NUM_CHANNELS 6 // Number of channels
...
#define IMU_USE  IMU_USE_I2C_MPU6050 // Select one: IMU_USE_SPI_MPU6500, IMU_USE_SPI_MPU9250, IMU_USE_SPI_MPU6000, IMU_USE_SPI_BMI270, IMU_USE_I2C_MPU9250, IMU_USE_I2C_MPU9150, IMU_USE_I2C_MPU6500, IMU_USE_I2C_MPU6050, IMU_USE_I2C_MPU6000
