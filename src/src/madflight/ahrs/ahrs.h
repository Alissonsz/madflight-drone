...
void Ahrs::computeAngles() {
  ...
  //Serial.print("AHRS: Roll:"); Serial.print(roll); Serial.print(" Pitch:"); Serial.print(pitch); Serial.print(" Yaw:"); Serial.println(yaw);
}
...
protected:
  void fusionUpdate() {
    ...
    //Serial.print("AHRS: q0:"); Serial.print(q0); Serial.print(" q1:"); Serial.print(q1); Serial.print(" q2:"); Serial.print(q2); Serial.print(" q3:"); Serial.print(q3); Serial.print("dt: "); Serial.println(imu.dt);
  }
};
